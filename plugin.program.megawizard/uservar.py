...
BUILDFILE = 'https://raw.githubusercontent.com/a4k-openproject/plugin.program.openwizard/refs/heads/master/resources/text/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]AK [/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}]) [/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing Adri Kodi Wizard.\nContact us on http://adri-kodi.com'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]AK[/B][/COLOR]Wizard'
